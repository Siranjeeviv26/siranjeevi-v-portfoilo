      ...
      <RevealOnScroll>
        <div className="w-full max-w-6xl px-6 mx-auto text-center">
          <motion.h2
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-4xl font-bold mb-12 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent"
          >
            Contact
          </motion.h2>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="p-10 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-lg hover:shadow-[0_0_25px_rgba(59,130,246,0.25)] transition-all"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              >
                <div className="bg-blue-500/10 p-4 rounded-xl mb-4 shadow-inner">
                  <svg
              ...
              >
                ...
                <a
                  ...
                  className="text-gray-300 hover:text-cyan-400 text-lg transition-colors break-all"
                >
